...
<meta charset="utf-8">
<title>Pyphilia | Portfolio</title>
<meta property='og:image' content='https://i.imgur.com/OaK5A9f.png'/>
<link rel="shortcut icon" type="image/png" href="https://i.imgur.com/OaK5A9f.png"/>
...
<body style="background:url(img/background.png)">
  ...
  <div class="container-fluid">
          ...
          <div class="row no-gutters align-items-center">
            ...
            <div class="col-lg-6 text">
              ...
              <span>
                ...
                <a class="button" href="mailto:klphanh@gmail.com">Contact Me</a>
              </span>
            </div>
    ...
    <div id="waypoint6"  class="project right">
      <h3><span>Personal Graphic Designs</span></h3>
      <div class="row">
        <div class="col-md-9 category">
          ...
          <div class="col-md-12">
            <span class="text">
              For almost 10 years, I learned and created graphic designs first using Gimp, then Adobe Photoshop. I received many requests throughout the years, for diverse purposes
              such as facebook covers, forum designs, posters, concert banners, fanbase logos. More recent works are published on my <a href="https://www.facebook.com/pyphilia/">facebook page</a>!
              <br>
              <span class="tag">Gimp</span> <span class="tag">Photoshop</span> <em>(Original images are not mine!)</em>
            </span>
          </div>
    ...
    <div id="waypoint6"  class="project right">
      <h3><span>PolyJapan Graphic Designs</span></h3>
      <div class="row">
        <div class="col-md-9 category">
          <div class="row thumbnails" id="lightgallery6">

            <a class="col-md-4" href="https://i.imgur.com/88feT1F.jpg"> <img src="https://i.imgur.com/88feT1Fl.jpg" alt=""/></a>
            <a class="col-md-4" href="https://i.imgur.com/3LBGN7m.png"> <img src="https://i.imgur.com/3LBGN7ml.png" alt=""/></a>
            <a class="col-md-4" href="https://i.imgur.com/mdcBENyl.jpg"> <img src="https://i.imgur.com/mdcBENyl.jpg" alt=""/></a>

          </div>
          <div class="col-md-12">
            <span class="text">
              Since mid-2018, I became the graphist of Polyjapan, a japanese association at my university campus. I am in charge of creating the flyers, posters and other graphical stuff for any events.
              Here are some of my work for them, and more is to come!
              <br>
              <span class="tag">Photoshop</span> <em>(Original images are not mine!)</em>
            </span>
          </div>
          ...
          <div id="waypoint3"  class="project left">
                ...
                <div class="col-md-12">
                  <span class="text">
                    ...
                    <a href="https://www.facebook.com/pyphilia/">facebook
                      page</a> to see more recent paintings! <br>
          ...
          <div class="row">
            ...
            <div class="col-md-8">
              <span class="text">
                ...
                Never been curious about which Pokémon was the most similar to Pikachu? Don't hesitate to visit and play with our visualisation: <a target="_blank" href="https://roblan11.github.io/DataVis/visualization/index.html">Link</a>
                <br>
                <span class="tag">D3.js</span> <span class="tag">HTML</span> <span class="tag">CSS</span> <span class="tag">Data Visualisation</span>
              </span>
            </div>
      ...
      <div class="row">
        <div class="col-md-9 category">
          <div class="row">
            ...
            <div class="col-md-8">
              <span class="text">
                Through the <em>Advanced Computer Graphics</em> course, I learned about Realistic Image Rendering, how lights interact with objects and how to synthese material.
                My final rendering, for the <em>Last One</em> theme, represents a watch tower, made of burnt wood, surrounded by huge rocks and dead trees, a dark and devasted world.<br>
                <span class="tag">Computer Graphics</span> <span class="tag">C++</span>
              </div>
                ...
                <div class="col-md-9 category">
                  ...
                  <div class="col-md-12">
                    <span class="text">
                      ...
                      At the end of the course, my team managed to render using C++ and OpenGL, procedural mountains colored by the sunset.<br>
                      <span class="tag">Computer Graphics</span> <span class="tag">C++</span> <span class="tag">OpenGL</span>
                    </span>
                  </div>
  ...
  <footer>Pyphi(lia) © 2012 - 2018
    <br>
    <a href="http://creatreasurebox.tumblr.com/"><img alt="partenariat logo" class="part" src="http://nsa38.casimages.com/img/2016/07/06/mini_160706105534339449.png"></a> \
    <a href="http://infinikey-locket.tumblr.com/"><img alt="partenariat logo" class="part" src="img/lockey.png"></a> \
    <a href="http://blacknoodle.e-monsite.com/"><img alt="partenariat logo" class="part" src="http://blacknoodle.e-monsite.com/medias/images/e-bouton-v36.png"></a> \
    <a href="http://borntobeatfrance.wordpress.com/"><img alt="partenariat logo" class="part" src="img/btob.png" width="100"></a>
